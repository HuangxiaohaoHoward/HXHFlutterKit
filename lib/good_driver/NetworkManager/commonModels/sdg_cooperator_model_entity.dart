class SDGCooperatorModelEntity {
	String logoUrlTwo;
	String domainName;
	String logoColorTwo;
	...
	SDGCooperatorModelEntity({this.logoUrlTwo, this.domainName, this.logoColorTwo, this.domainNameTwo, this.logoUrlOne, this.customerNumber, this.logoColorOne, this.customerName, this.username});

	SDGCooperatorModelEntity.fromJson(Map<String, dynamic> json) {
